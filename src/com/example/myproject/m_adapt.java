...
public class m_adapt extends ArrayAdapter<String> {
		...
		public m_adapt(Activity context, String[] itemname, Integer[] itemimg, String[] price) {
			super(context, R.layout.m_adapt, itemname);
		...
		public View getView(int position,View view,ViewGroup parent) {
			...
			View rowView=inflater.inflate(R.layout.m_adapt, null,true);
