...
public class vege_adapter extends ArrayAdapter<String> {
		...
		public vege_adapter(Activity context, String[] itemname, Integer[] itemimg, String[] price) {
			super(context, R.layout.vege_adapter1, itemname);
		...
		public View getView(int position,View view,ViewGroup parent) {
			...
			View rowView=inflater.inflate(R.layout.vege_adapter1, null,true);
