...
public class fruits_adapter extends ArrayAdapter<String> {
		...
		public fruits_adapter(Activity context, String[] itemname, Integer[] itemimg, String[] price) {
			super(context, R.layout.fruits_adapter1, itemname);
		...
		public View getView(int position,View view,ViewGroup parent) {
			...
			View rowView=inflater.inflate(R.layout.fruits_adapter1, null,true);
