...
public class grocery_adapter extends ArrayAdapter<String> {
		...
		public grocery_adapter(Activity context, String[] itemname, Integer[] itemimg, String[] price) {
			super(context, R.layout.grocery_adapter1, itemname);
		...
		public View getView(int position,View view,ViewGroup parent) {
			...
			View rowView=inflater.inflate(R.layout.grocery_adapter1, null,true);
